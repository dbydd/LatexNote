        ...
        \item {
              ...
              \begin{itemize}
                ...
                \item {
                      ...
                      椭圆抛物面在笛卡尔坐标系中的方程为:$z = \frac{x^2}{a^2} + \frac{y^2}{b^2}$
                      }
                \item {
                      双曲抛物面：

                      双曲抛物面在笛卡尔坐标系中的方程为:$z = \frac{x^2}{a^2} - \frac{y^2}{b^2}$
                      }
                \item {
                      单叶双曲面:

                      单叶双曲面在笛卡尔坐标系中的方程为:$\frac{x^2}{a^2} + \frac{y^2}{b^2} - \frac{z^2}{c^2} = 1$
                      }
                \item {
                      双叶双曲面:
                      //todo 全有毛病，重写
                      双叶抛物面在笛卡尔坐标系中的方程为:$\frac{x^2}{a^2} + \frac{y^2}{b^2} + \frac{z^2}{c^2} = 1$
                      }
              \end{itemize}
              }
      \end{itemize}
